...
var options = {
  ...
  $.ajax({
    url: `/report/view/dropoff/chartanalytics`,
    type: "GET", 
    async: false,
    dataType: 'json',
...
if (jQuery("#chartdiv").length && jQuery(document).ready(function() {}), 
	jQuery("#dropoff-month-chart").length) {
	options = {
		chart: {
			height: 350,
			type: "line",
	...
	(chart = new ApexCharts(document.querySelector("#dropoff-month-chart"), options)).render()
}
if (jQuery("#dropoff-day-chart").length) {
	options = {
		chart: {
			height: 350,
			type: "bar",
		...
		title: {
			text: "Number of dropoffs per day",
			align: "left"
		},
		grid: {
			row: {
	...
	(chart = new ApexCharts(document.querySelector("#dropoff-day-chart"), options)).render()

}
if (jQuery("#dropoff-week-chart").length) {
	options = {
		chart: {
			height: 350,
			type: "line",
		...
		title: {
			text: "Number of dropoffs per week",
			align: "left"
		},
		grid: {
			row: {
	...
	(chart = new ApexCharts(document.querySelector("#dropoff-week-chart"), options)).render()

}
if (jQuery("#dropoff-year-chart").length) {
	options = {
		chart: {
			height: 350,
			type: "bar",
		...
		title: {
			text: "Number of dropoffs per year",
			align: "left"
		},
		grid: {
			row: {
	...
	(chart = new ApexCharts(document.querySelector("#dropoff-year-chart"), options)).render()
...
if (jQuery("#prepaidpostpaid-column").length) {
	options = {
		...
		yaxis: {
			title: {
				text: "Number of drop offs by method"
			}
		},
		fill: {
			opacity: 1
