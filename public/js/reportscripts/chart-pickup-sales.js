...
var options = {
  ...
  $.ajax({
    url: `/report/view/pickup/chartanalytics`,
    type: "GET", 
    async: false,
    dataType: 'json',
...
if (jQuery("#chartdiv").length && jQuery(document).ready(function() {}), 
	jQuery("#pickup-month-chart").length) {
	options = {
		chart: {
			height: 350,
			type: "line",
	...
	(chart = new ApexCharts(document.querySelector("#pickup-month-chart"), options)).render()
}
if (jQuery("#pickup-day-chart").length) {
	options = {
		chart: {
			height: 350,
			type: "bar",
		...
		title: {
			text: "Number of pickups per day",
			align: "left"
		},
		grid: {
			row: {
	...
	(chart = new ApexCharts(document.querySelector("#pickup-day-chart"), options)).render()

}
if (jQuery("#pickup-week-chart").length) {
	options = {
		chart: {
			height: 350,
			type: "line",
		...
		title: {
			text: "Number of pickups per week",
			align: "left"
		},
		grid: {
			row: {
	...
	(chart = new ApexCharts(document.querySelector("#pickup-week-chart"), options)).render()

}
if (jQuery("#pickup-year-chart").length) {
	options = {
		chart: {
			height: 350,
			type: "bar",
		...
		title: {
			text: "Number of pickups per year",
			align: "left"
		},
		grid: {
			row: {
	...
	(chart = new ApexCharts(document.querySelector("#pickup-year-chart"), options)).render()
...
if (jQuery("#prepaidpostpaid-column").length) {
	options = {
		...
		yaxis: {
			title: {
				text: "Number of pickups by method"
			}
		},
		fill: {
			opacity: 1
