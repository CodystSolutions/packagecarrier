...
var options = {
  ...
  $.ajax({
    url: `/report/view/transaction/chartanalytics`,
    type: "GET", 
    async: false,
    dataType: 'json',
...
if (jQuery("#chartdiv").length && jQuery(document).ready(function() {}), 
	jQuery("#transaction-month-chart").length) {
	options = {
		chart: {
			height: 350,
			type: "line",
	...
	(chart = new ApexCharts(document.querySelector("#transaction-month-chart"), options)).render()
}
if (jQuery("#transaction-day-chart").length) {
	options = {
		chart: {
			height: 350,
			type: "bar",
	...
	(chart = new ApexCharts(document.querySelector("#transaction-day-chart"), options)).render()

}
if (jQuery("#transaction-week-chart").length) {
	options = {
		chart: {
			height: 350,
			type: "line",
	...
	(chart = new ApexCharts(document.querySelector("#transaction-week-chart"), options)).render()

}
if (jQuery("#transaction-year-chart").length) {
	options = {
		chart: {
			height: 350,
			type: "bar",
	...
	(chart = new ApexCharts(document.querySelector("#transaction-year-chart"), options)).render()
